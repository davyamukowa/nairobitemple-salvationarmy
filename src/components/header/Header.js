        ...
        <div className={collapsedClass + " navbar-collapse sbc-navbar-collapse"} id="navbarSupportedContent">
          ...
          <ul className="navbar-nav sbc-navbar-content">
            <li className="nav-item">
              <NavLink to="/" className="nav-link" activeClassName="active" onClick={this.navLinkClick}>Home</NavLink>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              <NavLink to="/events" className="nav-link" activeClassName="active" onClick={this.navLinkClick}>Church Calendar</NavLink>
            </li>
            <li className="nav-item">
              <NavLink to="/sermons" className="nav-link" activeClassName="active" onClick={this.navLinkClick}>Sermons</NavLink>
            </li>
            <li className="nav-item">
              <NavLink to="/Ministries" className="nav-link" activeClassName="active" onClick={this.navLinkClick}>Ministries</NavLink>
            </li>
            <li className="nav-item">
